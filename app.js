...
var _user$project$Bitmap$toList = function (_p0) {
	return _elm_lang$core$Array$toList(
		A2(_elm_lang$core$Array$map, _elm_lang$core$Array$toList, _p0));
};
var _user$project$Bitmap$fromList = function (_p1) {
	return _elm_lang$core$Array$fromList(
		A2(_elm_lang$core$List$map, _elm_lang$core$Array$fromList, _p1));
};
var _user$project$Bitmap$setPixel = F4(
	function (col, row, colour, bitmap) {
		var col1 = col - 1;
		var row1 = row - 1;
		return A2(
			...
			A2(
				...
				function (newRow) {
					return A3(_elm_lang$core$Array$set, row1, newRow, bitmap);
				},
				A2(
					_elm_lang$core$Maybe$map,
					A2(_elm_lang$core$Array$set, col1, colour),
					A2(_elm_lang$core$Array$get, row1, bitmap))));
	});
var _user$project$Bitmap$horizontalLine = F5(
	function (row, start, end, colour, bitmap) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (c, b) {
					return A4(_user$project$Bitmap$setPixel, c, row, colour, b);
				}),
			bitmap,
			A2(_elm_lang$core$List$range, start, end));
	});
var _user$project$Bitmap$verticalLine = F5(
	function (col, start, end, colour, bitmap) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (r, b) {
					return A4(_user$project$Bitmap$setPixel, col, r, colour, b);
				}),
			bitmap,
			A2(_elm_lang$core$List$range, start, end));
	});
var _user$project$Bitmap$cols = function (_p2) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		A2(
			...
			A2(_elm_lang$core$Array$get, 0, _p2)));
};
var _user$project$Bitmap$rows = _elm_lang$core$Array$length;
var _user$project$Bitmap$clear = F2(
	function (colour, bitmap) {
		var c = _user$project$Bitmap$cols(bitmap);
		var r = _user$project$Bitmap$rows(bitmap);
		return A2(
			_elm_lang$core$Array$repeat,
			r,
			A2(_elm_lang$core$Array$repeat, c, colour));
	});
var _user$project$Bitmap$initialize = F2(
	function (rows, cols) {
		return A2(
			_elm_lang$core$Array$repeat,
			rows,
			A2(_elm_lang$core$Array$repeat, cols, 0));
	});

var _user$project$Command$Show = {ctor: 'Show'};
var _user$project$Command$Clear = function (a) {
	return {ctor: 'Clear', _0: a};
};
var _user$project$Command$VerticalLine = F4(
	function (a, b, c, d) {
		return {ctor: 'VerticalLine', _0: a, _1: b, _2: c, _3: d};
	});
var _user$project$Command$HorizontalLine = F4(
	function (a, b, c, d) {
		return {ctor: 'HorizontalLine', _0: a, _1: b, _2: c, _3: d};
	});
var _user$project$Command$SetPixel = F3(
	function (a, b, c) {
		return {ctor: 'SetPixel', _0: a, _1: b, _2: c};
	});
var _user$project$Command$Initialize = F2(
	function (a, b) {
		return {ctor: 'Initialize', _0: a, _1: b};
	});

var _user$project$Runner$updateBitmap = function (command) {
	var _p0 = command;
	switch (_p0.ctor) {
		case 'SetPixel':
			return A3(_user$project$Bitmap$setPixel, _p0._0, _p0._1, _p0._2);
		case 'HorizontalLine':
			return A4(_user$project$Bitmap$horizontalLine, _p0._0, _p0._1, _p0._2, _p0._3);
		case 'VerticalLine':
			return A4(_user$project$Bitmap$verticalLine, _p0._0, _p0._1, _p0._2, _p0._3);
		case 'Show':
			return _elm_lang$core$Basics$identity;
		case 'Clear':
			return _user$project$Bitmap$clear(_p0._0);
		default:
			return _elm_lang$core$Basics$identity;
	}
};
var _user$project$Runner$initialize = function (command) {
	var _p1 = command;
	if (_p1.ctor === 'Initialize') {
		return _elm_lang$core$Maybe$Just(
			A2(_user$project$Bitmap$initialize, _p1._1, _p1._0));
	} else {
		return _elm_lang$core$Maybe$Nothing;
	}
};
var _user$project$Runner$applyCommand = F2(
	function (command, bitmap) {
		var _p2 = bitmap;
		if (_p2.ctor === 'Nothing') {
			return _user$project$Runner$initialize(command);
		} else {
			return _elm_lang$core$Maybe$Just(
				A2(_user$project$Runner$updateBitmap, command, _p2._0));
		}
	});
var _user$project$Runner$run = function (_p3) {
	return A2(
		_elm_lang$core$Result$fromMaybe,
		'Failed',
		A3(_elm_lang$core$List$foldl, _user$project$Runner$applyCommand, _elm_lang$core$Maybe$Nothing, _p3));
};

var _user$project$CommandParser$space = _elm_tools$parser$Parser$symbol(' ');
var _user$project$CommandParser$newLines = A2(
	_elm_tools$parser$Parser$repeat,
	_elm_tools$parser$Parser$oneOrMore,
	_elm_tools$parser$Parser$symbol('\n'));
var _user$project$CommandParser$show = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(_user$project$Command$Show),
	_elm_tools$parser$Parser$symbol('S'));
var _user$project$CommandParser$clear = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(
		_user$project$Command$Clear(0)),
	_elm_tools$parser$Parser$symbol('C'));
var _user$project$CommandParser$clearWithColour = A2(
	_elm_tools$parser$Parser$delayedCommit,
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		_elm_tools$parser$Parser$symbol('C'),
		_user$project$CommandParser$space),
	A2(
		_elm_tools$parser$Parser_ops['|='],
		_elm_tools$parser$Parser$succeed(_user$project$Command$Clear),
		_elm_tools$parser$Parser$int));
var _user$project$CommandParser$verticalLine = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_tools$parser$Parser_ops['|.'],
									_elm_tools$parser$Parser$succeed(_user$project$Command$VerticalLine),
									_elm_tools$parser$Parser$symbol('V')),
								_user$project$CommandParser$space),
							_elm_tools$parser$Parser$int),
						_user$project$CommandParser$space),
					_elm_tools$parser$Parser$int),
		...
		_user$project$CommandParser$space),
	_elm_tools$parser$Parser$int);
var _user$project$CommandParser$horizontalLine = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									_elm_tools$parser$Parser_ops['|.'],
									_elm_tools$parser$Parser$succeed(_user$project$Command$HorizontalLine),
		...
		_user$project$CommandParser$space),
	_elm_tools$parser$Parser$int);
var _user$project$CommandParser$setPixel = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						...
						A2(
							_elm_tools$parser$Parser_ops['|.'],
							_elm_tools$parser$Parser$succeed(_user$project$Command$SetPixel),
		...
		_user$project$CommandParser$space),
	_elm_tools$parser$Parser$int);
var _user$project$CommandParser$initialize = A2(
	_elm_tools$parser$Parser_ops['|='],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			...
			A2(
				...
				A2(
					_elm_tools$parser$Parser_ops['|.'],
					_elm_tools$parser$Parser$succeed(_user$project$Command$Initialize),
					_elm_tools$parser$Parser$symbol('I')),
				_user$project$CommandParser$space),
			_elm_tools$parser$Parser$int),
		_user$project$CommandParser$space),
	_elm_tools$parser$Parser$int);
var _user$project$CommandParser$command = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$oneOf(
		{
			ctor: '::',
			_0: _user$project$CommandParser$setPixel,
			_1: {
				ctor: '::',
				_0: _user$project$CommandParser$horizontalLine,
				_1: {
					ctor: '::',
					_0: _user$project$CommandParser$verticalLine,
					_1: {
						ctor: '::',
						_0: _user$project$CommandParser$clearWithColour,
						_1: {
							ctor: '::',
							_0: _user$project$CommandParser$clear,
							_1: {ctor: '[]'}
						}
					}
				}
	...
	_user$project$CommandParser$newLines);
var _user$project$CommandParser$mkProgram = F3(
	function (init, body, show) {
		return _elm_lang$core$List$concat(
			{
				ctor: '::',
				_0: {
...
var _user$project$CommandParser$commands = A2(
	_elm_tools$parser$Parser_ops['|.'],
	A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			...
			A2(
				...
				A2(
					...
					A2(
						_elm_tools$parser$Parser_ops['|='],
						_elm_tools$parser$Parser$succeed(_user$project$CommandParser$mkProgram),
						_user$project$CommandParser$initialize),
					_user$project$CommandParser$newLines),
				A2(_elm_tools$parser$Parser$repeat, _elm_tools$parser$Parser$zeroOrMore, _user$project$CommandParser$command)),
			_user$project$CommandParser$show),
		A2(_elm_tools$parser$Parser$repeat, _elm_tools$parser$Parser$zeroOrMore, _user$project$CommandParser$newLines)),
	_elm_tools$parser$Parser$end);
var _user$project$CommandParser$runParser = F2(
		...
		return A2(
			...
			function (e) {
				return A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(e.problem),
						A2(
							_elm_lang$core$Basics_ops['++'],
							' [row: ',
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(e.row),
								A2(
									_elm_lang$core$Basics_ops['++'],
									', col: ',
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(e.col),
										']'))))));
			},
			A2(_elm_tools$parser$Parser$run, parser, input));
	});
var _user$project$CommandParser$parse = _user$project$CommandParser$runParser(_user$project$CommandParser$commands);

var _user$project$Builder$build = function (instructions) {
	return A2(
		_elm_lang$core$Result$andThen,
		_user$project$Runner$run,
		_user$project$CommandParser$parse(instructions));
};

var _user$project$Main$bitmapToString = function (_p0) {
	return A2(
		_elm_lang$core$String$join,
		'\n',
		A2(
			...
			A2(
				_elm_lang$core$List$map,
				_elm_lang$core$List$map(_elm_lang$core$Basics$toString),
				_user$project$Bitmap$toList(_p0))));
};
var _user$project$Main$bitmap = function (model) {
	var _p1 = model;
	if (_p1.ctor === 'Ok') {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('bitmap'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					_user$project$Main$bitmapToString(_p1._0)),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		return {
			ctor: '_Tuple2',
			_0: _user$project$Builder$build(_p2._0),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$Main$subscriptions = function (_p3) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: _elm_lang$core$Result$Err('Write your program'),
	_1: _elm_lang$core$Platform_Cmd$none
};
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$textarea,
				{
					...
					_0: A2(
						_elm_lang$html$Html_Events$on,
						'input',
						A2(_elm_lang$core$Json_Decode$map, _user$project$Main$Update, _elm_lang$html$Html_Events$targetValue)),
					_1: {
						ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$bitmap(model),
				_1: {ctor: '[]'}
			}
		});
};
